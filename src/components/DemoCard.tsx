...
export function DemoCard({ id, title, description }: DemoCardProps) {
  return (
    <div className="p-2">
      <article className="min-w-[200px] rounded-2xl border-2 border-[#fbf0df]/30 bg-[#1a1a1a]/60 backdrop-blur-sm overflow-hidden hover:border-[#f3d5a3] transition-colors duration-200">

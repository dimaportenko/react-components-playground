        ...
        <div className="mb-6">
          ...
          <div className="hero-content">
            ...
            <p className="text-white/60">
              Experience smooth scroll-triggered animations using GSAP's
...
const ScrollExamples = () => (
  <div className="space-y-20">
    ...
    <section className="scroll-card bg-gradient-to-br from-black/40 to-black/20 backdrop-blur-sm p-8 rounded-lg border border-[#f3d5a3]/20">
      <h2 className="text-2xl font-semibold mb-4 text-[#f3d5a3] text-reveal">
        Fade In Animation
      </h2>
      <p className="text-white/80 text-reveal">
        This section demonstrates a fade-in animation triggered when it enters
        the viewport. The content smoothly transitions from invisible to visible
        with a subtle upward movement.
      </p>
    </section>
    ...
    <section className="scroll-card bg-gradient-to-br from-black/40 to-black/20 backdrop-blur-sm p-8 rounded-lg border border-[#f3d5a3]/20">
      ...
      <p className="text-white/80 text-reveal">
        Each text element animates in from the left with a staggered timing
        effect. This creates a natural reading flow and draws attention to the
    ...
    <section className="parallax-section relative overflow-hidden bg-gradient-to-br from-black/60 to-black/40 backdrop-blur-sm p-12 rounded-lg border border-[#f3d5a3]/20 min-h-[60vh] flex items-center">
      ...
      <div className="relative z-10 max-w-2xl">
        <h2 className="text-3xl font-bold mb-6 text-[#f3d5a3] text-reveal">
          Parallax Background
        </h2>
        <p className="text-lg text-white/90 text-reveal">
          This section features a parallax background that moves at a different
          speed than the content, creating depth and visual interest as you
          scroll. The background gradient shifts and moves independently from
          the text content.
        </p>
      </div>
    </section>
    ...
    <section className="scroll-card bg-gradient-to-br from-black/40 to-black/20 backdrop-blur-sm p-8 rounded-lg border border-[#f3d5a3]/20">
      ...
      <p className="text-white/80 text-reveal">
        Elements can scale in from smaller sizes, creating an engaging zoom
        effect. This animation technique is perfect for highlighting important
        content sections.
      </p>
    </section>
    ...
    <section className="scroll-card bg-gradient-to-br from-black/40 to-black/20 backdrop-blur-sm p-8 rounded-lg border border-[#f3d5a3]/20">
      ...
      <p className="text-white/80 text-reveal">
        ...
        creating a smooth bi-directional effect that enhances the scrolling
        experience.
      </p>
    </section>
    ...
    <section className="scroll-card bg-gradient-to-br from-[#f3d5a3]/10 to-[#fbf0df]/10 backdrop-blur-sm p-12 rounded-lg border border-[#f3d5a3]/40 text-center">
      ...
      <p className="text-xl text-white/90 max-w-2xl mx-auto text-reveal">
        You've experienced various scroll-triggered animations. These techniques
        can be combined and customized to create rich, interactive experiences
        that engage users as they explore your content.
      </p>
